...
void
x_fread(void *, size_t, size_t, FILE *, char *, int);
...
void
x_stretch_points(int np, double *p1_v, double *p2_v, int method, int debug);
...
void
_grd3d_imp_roff_asc_grd(int *num_act,
                        int *num_subgrds,
                        double *coordsv,
                        double *zcornsv,
                        int *actnumsv,
...
void
_grd3d_imp_roff_bin_grd(int *num_act,
                        int *num_subgrds,
                        double *coordsv,
                        double *zcornsv,
                        int *actnumsv,
...
void
_grd3d_imp_roff_asc_prp(int nx,
                        int ny,
                        int nz,
                        char *prop_name,
                        int *p_int_v,
...
void
_grd3d_imp_roff_bin_prp(int nx,
                        int ny,
                        int nz,
                        char *prop_name,
                        int *p_int_v,
...
int
_grd3d_roffbinstring(char *bla, FILE *fc);

float
_grd3d_getfloatvalue(char *name, FILE *fc);

int
_grd3d_getintvalue(char *name, FILE *fc);

void
_grd3d_getfloatarray(float *array, int num, FILE *fc);

// TODO shall be UNSIGNED char?
void
_grd3d_getbytearray(char *array, int num, FILE *fc);

void
_grd3d_getintarray(int *array, int num, FILE *fc);

void
_grd3d_getchararray(char **array, int num, FILE *fc);

void
_grd3d_getchararray1d(char *array, int num, FILE *fc);

void
_grd3d_roff_to_xtg_grid(int nx,
                        int ny,
                        int nz,
                        float xoffset,
                        float yoffset,
...
int
u_wri_ecl_bin_record(char *cname,
                     char *ctype,
                     int reclen,
                     int *tmp_int_v,
                     float *tmp_float_v,
