...
class TSurfData(
    ...
    def from_file(
        ...
        with TSurfData._get_text_stream(wrapped_file, encoding) as stream:
            return TSurfData._parse_tsurf(stream, str(wrapped_file.name))
    ...
    def to_file(
        ...
        Args:
            ...
            file: Path to output TSurf file (str or Path) or
                a file-like object (BytesIO or StringIO).
            encoding: Text encoding for writing the file
