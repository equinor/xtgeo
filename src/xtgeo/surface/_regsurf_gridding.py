...
def points_kriging_gridding(
    ...
    Args:
        ...
        len_scale: Correlation length (range). If None, auto-estimated from data.
            ...
            First value is major axis (X or Easting), second is minor axis (Y or
            Northing).
        range_value: Alternative to len_scale. If provided, converted to len_scale via
            ...
            is given. Can be single value or tuple for anisotropy. First value is
            major axis (X or Easting), second is minor axis (Y or Northing).
        ...
        angle: Rotation angle in degrees for anisotropic variograms (GSTools
            convention: counter-clockwise from East/X-axis). Only used when
            len_scale is a tuple (anisotropic). Default None (0 degrees).
            Examples: 0°=East, 90°=North, 45°=Northeast, -45°=Southeast.
    ...
    Example::
        ...
        # Anisotropic kriging with rotation angle
        surf.gridding(points, method='kriging',
                     method_options={
                         'len_scale': (2000, 500),  # major=2000m, minor=500m
                         'angle': 45  # 45° counter-clockwise from East (NE direction)
                     })
    """
