...
def surface_from_file(mfile, fformat=None, template=None, values=True, engine="cxtgeo"):
    ...
    return RegularSurface.read_file(
...
def surface_from_cube(cube, value):
    ...
    """
    return RegularSurface.read_cube(cube, value)
    ...
    def wrapper(cls, *args, **kwargs):
        ...
        if "sfile" in kwargs or len(args) == 1:
            warnings.warn(
                ...
                'the file type instead, or RegularSurface.read_file("file_name")',
                DeprecationWarning,
            )
...
class RegularSurface:
    ...
    @classmethod
    def read_zmap_ascii(cls, mfile, values):
    ...
    def read_file(
        ...
        **kwargs,
        ...
        Example::
            ...
            >>> mymapobject = RegularSurface.read_file('myfile.x')
    ...
    @deprecation.deprecated(
        ...
        removed_in="3.0",
        current_version=xtgeo.version,
        details="Use the read_hdf classmethod instead",
    )
    def from_hdf(
        self,
        mfile: Union[str, pathlib.Path, io.BytesIO],
    ...
    def read_hdf(
        ...
        Example:
            >>> import xtgeo
            >>> mysurf = xtgeo.RegularSurface.read_hdf("surf1.hdf")

        .. versionadded:: 2.14
        """
        # developing, in prep and experimental!
        mfile = xtgeosys._XTGeoFile(mfile, mode="rb")
    ...
    def read_roxar(
        ...
        Note that a shortform to::
          ...
          import xtgeo
          mysurf = xtgeo.RegularSurface.read_roxar(project, 'name', 'category')
    ...
    @deprecation.deprecated(
        ...
        removed_in="3.0",
        current_version=xtgeo.version,
        details="Use the read_roxar classmethod instead",
    )
    def from_roxar(
