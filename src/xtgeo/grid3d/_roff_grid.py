...
from typing import IO, TYPE_CHECKING, Any, MutableMapping, Optional, Sequence, Union
...
class RoffGrid:
    ...
    @staticmethod
    def from_xtgeo_grid(xtgeo_grid: grid.Grid) -> RoffGrid:
        """
        Args:
            An xtgeo.Grid
        Returns:
