...
def from_file(gfile, fformat=None, **kwargs):  # pylint: disable=too-many-branches
    ...
    if fformat == "roff":
        ...
        result.update(
            _grid_import_ecl.import_ecl_egrid(gfile, fileformat="egrid", **kwargs)
        )
    elif fformat == "fegrid":
        result.update(
            _grid_import_ecl.import_ecl_egrid(gfile, fileformat="fegrid", **kwargs)
        )
    elif fformat == "grdecl":
