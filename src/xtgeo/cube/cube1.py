...
class Cube:
    ...
    def __init__(
        ...
        rotation: float = 0.0,
        zflip: Literal[1, -1] = 1,
        ilines: np.array | None = None,
        xlines: np.array | None = None,
        traceidcodes: np.array | None = None,
